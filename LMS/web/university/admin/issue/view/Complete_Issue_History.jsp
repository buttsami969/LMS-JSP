            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                       ...
                       <a href="<%=Common_Things.url %>/add-student/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna" %>" class="btn btn-warning">Add Student</a>
                       <a href="<%=Common_Things.url %>/view-all-pending-issues/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna" %>" class="btn btn-warning">View All Pending History</a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-heading"style="background: linear-gradient(to right, #fc4a1a, #f7b733);">Issue History
                           	...
                           	%>
                                   			  ...
                                   			  <tr>
                                                <td><%=temp_count++ %></td>
                                                 <td> <a href="<%=Common_Things.url %>/complete-details-student/?lm=<%=obj_Issue_Use_Bean.getStudent_id() %>" class="btn btn-warning btn-xs"><%=obj_Issue_Use_Bean.getStudent_name() %></a>          </td>
