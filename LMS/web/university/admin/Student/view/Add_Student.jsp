                ...
                <div class="content-wrap">
                    ...
                    <div class="col-lg-8">
							...
							%>
                                ...
                                <div class="panel-heading" style="background: linear-gradient(to right, #fc4a1a, #f7b733);">Recently Added Students 
                                ...
                                <ul class="list-group">
                              	...
                              	List<Student_Use_Bean> list_students=obj_Student_Table_Model.get_all_recently_added_students();
                                	  ...
                                	  <li class="list-group-item">
                                       ...
                                       <a href="<%=Common_Things.url %>/complete-details-student/?lm=<%=obj_Student_Use_Bean.getStudent_id() %>" class="btn btn-warning btn-xs"><%=obj_Student_Use_Bean.getStudent_name() %></a>  </div>
