                        ...
                        <section class="panel">
                            ...
                            <div class="col-lg-4">
                                <section  class="panel panel-warning">
                                    <div style="background: linear-gradient(to right, #fc4a1a, #f7b733); border:none;" class="panel-heading">Recently Added Books 
                                    ...
                                    <ul  class="list-group">
                                        ...
                                        <li  class="list-group-item">
                                            ...
                                            <div class="show no-margin pd-t-xs">
                                                ...
                                                <a href="<%=Common_Things.url%>/complete-details-of-book/?s=<%=obj_Book_Use_Bean.getBook_sl_no()%>"  class="btn btn-warning btn-xs" ><%=obj_Book_Use_Bean.getBook_title()%></a>
                                            </div>
