            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        ...
                        <a style="margin-left:15px; margin-right:10px;"  href="<%=Common_Things.url%>/admin-add-book/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna"%>" class="btn btn-warning">Add Book</a>
                        <a style="margin-right:10px;"  href="<%=Common_Things.url%>/view-all-books/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna"%>" class="btn btn-success">View All Books</a>
                        <a href="<%=Common_Things.url%>/search-book/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna"%>" class="btn btn-danger">Search Book</a>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-lg-12" >
                                        <section class="panel  panel-warning ">
                                            <div style=" color:white;background: linear-gradient(to right, #fc4a1a, #f7b733);"class="panel-heading">View All Books 
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped   table-bordered table-hover  ">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr> 
                                                                <td><%=temp_count++%></td>
                                                                <td>      	<a href="<%=Common_Things.url%>/complete-details-of-book/?s=<%=obj_Book_Use_Bean.getBook_sl_no()%>"  class="btn btn-warning btn-xs" ><%=obj_Book_Use_Bean.getBook_title()%></a></td>
                                                                <td>
                                                                    <a href="<%=Common_Things.url%>/search-book/?search=<%=obj_Book_Use_Bean.getCategory_name()%>"  class="btn btn-warning btn-xs" ><%=obj_Book_Use_Bean.getCategory_name()%></a>

                                                                </td>



                                                                <td><% if (obj_Book_Use_Bean.getAuthor_name() != null) {
                                                       out.println(obj_Book_Use_Bean.getAuthor_name());
                                                   } %></td>
                                                                <td><% if (obj_Book_Use_Bean.getPublisher_name() != null) {
                                                       out.println(obj_Book_Use_Bean.getPublisher_name());
                                                   } %></td>
                                                                <td><% if (obj_Book_Use_Bean.getIsbn() != null) {
                                                      out.println(obj_Book_Use_Bean.getIsbn());
                                                  } %></td>
