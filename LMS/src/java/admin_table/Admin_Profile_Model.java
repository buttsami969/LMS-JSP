...
public class Admin_Profile_Model {
    ...
    public Admin_Use_Bean admin_sign_in(Admin_Use_Bean obj_Admin_Use_Bean) {
        ...
        try {
            ...
            String query = "select * from admin where user_name=? or emial=?";
            ...
            if (rs.next()) {
                ...
                boolean passwordmatch = PasswordUtils.verifyUserPassword(obj_Admin_Use_Bean.getPassword(), password1, salt);
                if (passwordmatch) {
