...
public class Create_Table {
		...
		public static void call_me() {
			...
			try {
				...
				st.execute("insert into admin(user_name,email,password,gender,salt) values('admin','buttsami969@gmail.com','admin','male','gaklgnamrruirksjsrnssj')");
