  ...
  <%@include file="../../../../cursor.jsp" %>
            ...
            <section class="main-content">
                ...
                <div class="content-wrap" >
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-6"> 
                            <h3 class="no-margin text-white">Add Category</h3>
                                                ...
                                                <div class="panel-body" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <section class="panel panel-warning">
                                                            <div class="panel-heading text-white" style=" background: linear-gradient(to right, #fc4a1a, #f7b733);">Categories
                                                                ...
                                                                <table class="table table-hover no-margin">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><%if (obj_Category_Use_Bean.getProfile() != null) {
                                                        out.println(obj_Category_Use_Bean.getProfile());
                                                    }%></td>
                                                                            <td><a href="<%=Common_Things.url%>/edit-category/?sl_no=<%=obj_Category_Use_Bean.getSl_no()%>&n=<%=obj_Category_Use_Bean.getCategory_name()%>&d=<%=obj_Category_Use_Bean.getProfile()%>" class="btn btn-info btn-xs">Edit</a> </td>
                                                                        </tr>
