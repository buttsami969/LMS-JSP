                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                       ...
                       <a href="<%=Common_Things.url %>/add-student/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna" %>" class="btn btn-warning">Add Student</a>
                        ...
                        <a href="<%=Common_Things.url %>/view-all-students/<%=12 %>" class="btn btn-danger">View All Students</a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-heading" style="color:white; background:linear-gradient(to right, #fc4a1a, #f7b733);">View All Students 
                           	...
                           	%>
                                               ...
                                               <td> <a href="<%=Common_Things.url %>/complete-details-student/?lm=<%=obj_Student_Use_Bean.getStudent_id() %>" class="btn btn-warning btn-xs"><%=obj_Student_Use_Bean.getStudent_name() %></a>          </td>
