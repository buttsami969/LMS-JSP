					...
					<div class="row">
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-heading" style="background: linear-gradient(to right, #fc4a1a, #f7b733);">Author 
                           	...
                           	%>
                                                ...
                                                <td><%if(obj_Author_Use_Bean.getProfile()!=null){out.println(obj_Author_Use_Bean.getProfile());} %></td>
                                               	<td><a href="<%=Common_Things.url  %>/edit-author/?sl_no=<%=obj_Author_Use_Bean.getSl_no() %>&n=<%=obj_Author_Use_Bean.getAuthor_name() %>&d=<%=obj_Author_Use_Bean.getProfile() %>" class="btn btn-dark btn-xs">Edit</a> </td>
                                            </tr>
